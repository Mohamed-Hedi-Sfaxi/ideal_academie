...
<body>
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left">
                ...
                <a href="{{ route('home') }}" class="logo logo-small">
                    <img src="{{ URL::to('assets/img/logo-small.jpg') }}" alt="Logo" width="30" height="30">
                </a>
            </div>
            ...
            <ul class="nav user-menu">
                <li class="nav-item dropdown has-arrow new-user-menus">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('user/profile/page') }}">Mon Profil</a>
        ...
        @yield('content')
        <footer> 
            <span class="font-weight-bold">Copyright &copy; <script>document.write(new Date().getFullYear());</script> :</span> Isra Ben Yahia 
        </footer>
    </div>
